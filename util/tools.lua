...
function tools.permission(object, allow_type)
    ...
    return {
        id = object.id,
        type = object.__name == "Role" and dia.enums.appCommandPermissionType.role or
            dia.enums.appCommandPermissionType.user,
        permission = allow_type
    }
end
...
function tools.slashCommand(name, description)
    return tools.applicationCommand():setName(name):setDescription(description):setType(dia.enums.appCommandType
        .chatInput)
end
...
function tools.subCommandGroup(name, description)
    return tools.option():setName(name):setDescription(description):setType(dia.enums.appCommandOptionType
        .subCommandGroup)
end
